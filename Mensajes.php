...
<div class="modal fade" id="eliminaTema" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <footer class="container-fluid mt-3">
    <div class="row bg-dark text-light">
        <div class="col">
            <p class="text-center">Copyright Rivera Pérez Benjamín (c) 2020. Todos los derechos reservados.</p>
            <p class="text-center"><a href="mailto:">riverabenjamin759@gmail.com</a></p>
        </div>
    </div>
</footer>
